...
namespace KhachSan_GIU {
    ...
    public partial class QuanLyKSDataSet : global::System.Data.DataSet {
        ...
        public partial class hoadonDataTable : global::System.Data.TypedTableBase<hoadonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public hoadonRow AddhoadonRow(string mahd, string makh, System.DateTime ngaylap, int songaytro, double tienphong, double thanhtien, string maphong) {
            ...
            private void InitClass() {
                ...
                this.columnsongaytro.AllowDBNull = false;
        ...
        public partial class hoadonRow : global::System.Data.DataRow {
            ...
            public int songaytro {
                get {
                    return ((int)(this[this.tablehoadon.songaytroColumn]));
                }
                set {
                    this[this.tablehoadon.songaytroColumn] = value;
                }
            }
...
namespace KhachSan_GIU.QuanLyKSDataSetTableAdapters {
    ...
    public partial class hoadonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[hoadon] WHERE (([mahd] = @Original_mahd) AND ([makh] = @Original_makh) AND ([ngaylap] = @Original_ngaylap) AND ([songaytro] = @Original_songaytro) AND ([tienphong] = @Original_tienphong) AND ([thanhtien] = @Original_thanhtien) AND ([maphong] = @Original_maphong))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[hoadon] ([mahd], [makh], [ngaylap], [songaytro], [tienphong], [thanhtien], [maphong]) VALUES (@mahd, @makh, @ngaylap, @songaytro, @tienphong, @thanhtien, @maphong);
SELECT mahd, makh, ngaylap, songaytro, tienphong, thanhtien, maphong FROM hoadon WHERE (mahd = @mahd)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[hoadon] SET [mahd] = @mahd, [makh] = @makh, [ngaylap] = @ngaylap, [songaytro] = @songaytro, [tienphong] = @tienphong, [thanhtien] = @thanhtien, [maphong] = @maphong WHERE (([mahd] = @Original_mahd) AND ([makh] = @Original_makh) AND ([ngaylap] = @Original_ngaylap) AND ([songaytro] = @Original_songaytro) AND ([tienphong] = @Original_tienphong) AND ([thanhtien] = @Original_thanhtien) AND ([maphong] = @Original_maphong));
SELECT mahd, makh, ngaylap, songaytro, tienphong, thanhtien, maphong FROM hoadon WHERE (mahd = @mahd)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::KhachSan_GIU.Properties.Settings.Default.QuanLyKSConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT mahd, makh, ngaylap, songaytro, tienphong, thanhtien, maphong FROM dbo.hoa" +
                "don";
        ...
        public virtual int Fill(QuanLyKSDataSet.hoadonDataTable dataTable) {
        ...
        public virtual QuanLyKSDataSet.hoadonDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QuanLyKSDataSet.hoadonDataTable dataTable = new QuanLyKSDataSet.hoadonDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QuanLyKSDataSet.hoadonDataTable dataTable) {
        ...
        public virtual int Delete(string Original_mahd, string Original_makh, System.DateTime Original_ngaylap, int Original_songaytro, double Original_tienphong, double Original_thanhtien, string Original_maphong) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_songaytro));
        ...
        public virtual int Insert(string mahd, string makh, System.DateTime ngaylap, int songaytro, double tienphong, double thanhtien, string maphong) {
            if ((mahd == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(songaytro));
            this.Adapter.InsertCommand.Parameters[4].Value = ((double)(tienphong));
        ...
        public virtual int Update(string mahd, string makh, System.DateTime ngaylap, int songaytro, double tienphong, double thanhtien, string maphong, string Original_mahd, string Original_makh, System.DateTime Original_ngaylap, int Original_songaytro, double Original_tienphong, double Original_thanhtien, string Original_maphong) {
            if ((mahd == null)) {
                throw new global::System.ArgumentNullException("mahd");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(songaytro));
            this.Adapter.UpdateCommand.Parameters[4].Value = ((double)(tienphong));
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_songaytro));
            this.Adapter.UpdateCommand.Parameters[11].Value = ((double)(Original_tienphong));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string makh, System.DateTime ngaylap, int songaytro, double tienphong, double thanhtien, string maphong, string Original_mahd, string Original_makh, System.DateTime Original_ngaylap, int Original_songaytro, double Original_tienphong, double Original_thanhtien, string Original_maphong) {
            return this.Update(Original_mahd, makh, ngaylap, songaytro, tienphong, thanhtien, maphong, Original_mahd, Original_makh, Original_ngaylap, Original_songaytro, Original_tienphong, Original_thanhtien, Original_maphong);
        }
    }
